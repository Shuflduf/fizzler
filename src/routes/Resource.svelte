<script lang="ts">
	let {
		...
		link,
		flipped
	}: { children: any; name: string; imgPath: string; link: string; flipped: boolean } = $props();
</script>
...
>
	<a
		href={link}
		class="group text-center font-[Arvo] text-2xl font-bold text-nowrap underline decoration-2"
	>
